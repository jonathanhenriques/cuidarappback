...
VALUES ( 'a65bee75-2cb1-49d8-a31b-dfb6cbba39a3', 'Antonio', DATE('1974-01-01'), 49, '501818352', 'VIUVO', 7, 'Nineuda resp', '11940551452', '40551452', 'facebook.com', 'instagram.com', 'email@email.com', 'Professor', 'Rua das Árvores', '94', 'Bairro Lindo', 'São Bernardo', '09981011', 'OUTRO', 'do lado da granja', false, 'n/a', 'n/a', true, 'observado', true, 'Andreia irmã', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

INSERT INTO tb_paciente ( codigo, nome, data_nasc, idade, rg, estado_civil, qtd_filhos, nome_responsavel_paciente, cont_celular, cont_telefone, cont_facebook, cont_instagram, cont_email, profissao, end_rua, end_numero, end_bairro, end_cidade, end_cep, end_tipo_residencia, end_observacao, is_deficiente, deficiencia, deficiencia_familia, has_convenio, observacao, is_aceite, indicacao, is_ativo, data_cadastro, data_atualizacao)
VALUES ( '7884fd62-f27e-4e5d-bd03-c50333c48f71', 'Rosinete', DATE('1974-01-01'), 47, '501818352', 'DIVORCIADO', 7, 'Marinalva resp', '1140675391', '40675391', 'facebook.com', 'instagram.com', 'email@email.com', 'Enfermeira', 'Rua Moyses Cheidde', '94', 'Bairro Planalto', 'São Bernardo', '09890190', 'APARTAMENTO', 'do lado da madeireira', false, 'n/a', 'n/a', true, 'observado', true, 'Net irmã', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

INSERT INTO tb_paciente ( codigo, nome, data_nasc, idade, rg, estado_civil, qtd_filhos, nome_responsavel_paciente, cont_celular, cont_telefone, cont_facebook, cont_instagram, cont_email, profissao, end_rua, end_numero, end_bairro, end_cidade, end_cep, end_tipo_residencia, end_observacao, is_deficiente, deficiencia, deficiencia_familia, has_convenio, observacao, is_aceite, indicacao, is_ativo, data_cadastro, data_atualizacao)
VALUES ( '6f00edf7-d3fa-42a2-a643-cf2d7b5169a5', 'Batista', DATE('1974-01-01'), 70, '501818352', 'SOLTEIRO', 7, 'Nireide resp', '1140028922', '40028922', 'facebook.com', 'instagram.com', 'email@email.com', 'Caminhoneiro', 'Rua São Bernardo', '189', 'Bairro Inamar', 'Diadema', '09981011', 'CASA', 'do lado da igreja', false, 'n/a', 'n/a', true, 'observado', true, 'Nireide esposa', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

INSERT INTO tb_paciente ( codigo, nome, data_nasc, idade, rg, estado_civil, qtd_filhos, nome_responsavel_paciente, cont_celular, cont_telefone, cont_facebook, cont_instagram, cont_email, profissao, end_rua, end_numero, end_bairro, end_cidade, end_cep, end_tipo_residencia, end_observacao, is_deficiente, deficiencia, deficiencia_familia, has_convenio, observacao, is_aceite, indicacao, is_ativo, data_cadastro, data_atualizacao)
VALUES ( 'afe5b29e-35c8-40f6-b601-f8609c5fa080', 'Nireide', DATE('1974-01-01'), 68, '501818352', 'CASADO', 7, 'Batista resp', '11983181377', '83181377', 'facebook.com', 'instagram.com', 'email@email.com', 'Dona de Casa', 'Av São Bernardo', '189', 'Bairro inamar', 'Diadema', '09981011', 'OUTRO', 'do lado do bar', false, 'n/a', 'n/a', true, 'observado', true, 'Batista marido', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

INSERT INTO tb_paciente ( codigo, nome, data_nasc, idade, rg, estado_civil, qtd_filhos, nome_responsavel_paciente, cont_celular, cont_telefone, cont_facebook, cont_instagram, cont_email, profissao, end_rua, end_numero, end_bairro, end_cidade, end_cep, end_tipo_residencia, end_observacao, is_deficiente, deficiencia, deficiencia_familia, has_convenio, observacao, is_aceite, indicacao, is_ativo, data_cadastro, data_atualizacao)
VALUES ( 'afe5b29e-35c8-40f6-b601-f8609c5fa081', 'João', DATE('1985-06-20'), 38, '202020202', 'SOLTEIRO', 0, NULL, '11999999999', NULL, 'joao_facebook', 'joao_instagram', 'joao@email.com', 'Engenheiro', 'Rua das Flores', '123', 'Centro', 'São Paulo', '01234567', 'CASA', 'Próximo ao parque', false, NULL, NULL, false, NULL, true, 'Amigo indicou', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);


INSERT INTO tb_paciente ( codigo, nome, data_nasc, idade, rg, estado_civil, qtd_filhos, nome_responsavel_paciente, cont_celular, cont_telefone, cont_facebook, cont_instagram, cont_email, profissao, end_rua, end_numero, end_bairro, end_cidade, end_cep, end_tipo_residencia, end_observacao, is_deficiente, deficiencia, deficiencia_familia, has_convenio, observacao, is_aceite, indicacao, is_ativo, data_cadastro, data_atualizacao)
VALUES ( 'afe5b29e-35c8-40f6-b601-f8609c5fa082', 'Maria', DATE('1990-03-12'), 33, '303030303', 'CASADO', 2, 'Carlos resp', '11987654321', '11223344', 'carlos_facebook', 'carlos_instagram', 'carlos@email.com', 'Advogada', 'Avenida das Palmeiras', '500', 'Jardins', 'São Paulo', '02345678', 'APARTAMENTO', 'Próximo ao shopping', true, 'Nenhuma', 'Nenhuma', true, 'Paciente VIP', true, 'Indicação médica', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

INSERT INTO tb_paciente ( codigo, nome, data_nasc, idade, rg, estado_civil, qtd_filhos, nome_responsavel_paciente, cont_celular, cont_telefone, cont_facebook, cont_instagram, cont_email, profissao, end_rua, end_numero, end_bairro, end_cidade, end_cep, end_tipo_residencia, end_observacao, is_deficiente, deficiencia, deficiencia_familia, has_convenio, observacao, is_aceite, indicacao, is_ativo, data_cadastro, data_atualizacao)
VALUES ( 'afe5b29e-35c8-40f6-b601-f8609c5fa083', 'Ana', DATE('1982-11-05'), 40, '404040404', 'DIVORCIADO', 1, 'Pedro resp', '11944444444', '98765432', 'pedro_facebook', 'pedro_instagram', 'pedro@email.com', 'Médica', 'Rua das Montanhas', '70', 'Vila Bela', 'Campinas', '03456789', 'CASA', 'Próximo ao parque', false, NULL, NULL, false, NULL, true, 'Indicação de amigo', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

INSERT INTO tb_paciente ( codigo, nome, data_nasc, idade, rg, estado_civil, qtd_filhos, nome_responsavel_paciente, cont_celular, cont_telefone, cont_facebook, cont_instagram, cont_email, profissao, end_rua, end_numero, end_bairro, end_cidade, end_cep, end_tipo_residencia, end_observacao, is_deficiente, deficiencia, deficiencia_familia, has_convenio, observacao, is_aceite, indicacao, is_ativo, data_cadastro, data_atualizacao)
VALUES ( 'afe5b29e-35c8-40f6-b601-f8609c5fa084', 'Pedro', DATE('1978-09-28'), 45, '505050505', 'CASADO', 3, 'Marina resp', '11911111111', '33224455', 'marina_facebook', 'marina_instagram', 'marina@email.com', 'Engenheiro Civil', 'Rua dos Campos', '987', 'Centro', 'Belo Horizonte', '04567890', 'APARTAMENTO', 'Próximo ao metrô', true, 'Nenhuma', 'Nenhuma', true, 'Observações importantes', true, 'Indicação de colega', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);


INSERT INTO tb_paciente ( codigo, nome, data_nasc, idade, rg, estado_civil, qtd_filhos, nome_responsavel_paciente, cont_celular, cont_telefone, cont_facebook, cont_instagram, cont_email, profissao, end_rua, end_numero, end_bairro, end_cidade, end_cep, end_tipo_residencia, end_observacao, is_deficiente, deficiencia, deficiencia_familia, has_convenio, observacao, is_aceite, indicacao, is_ativo, data_cadastro, data_atualizacao)
VALUES ( 'afe5b29e-35c8-40f6-b601-f8609c5fa085', 'Carla', DATE('1989-12-10'), 33, '606060606', 'SOLTEIRO', 0, NULL, '11922222222', NULL, 'carla_facebook', 'carla_instagram', 'carla@email.com', 'Psicóloga', 'Rua das Rosas', '222', 'Jardim Florido', 'Porto Alegre', '05678901', 'CASA', 'Próximo à praça', false, NULL, NULL, false, NULL, true, 'Indicação de vizinho', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);


INSERT INTO tb_paciente ( codigo, nome, data_nasc, idade, rg, estado_civil, qtd_filhos, nome_responsavel_paciente, cont_celular, cont_telefone, cont_facebook, cont_instagram, cont_email, profissao, end_rua, end_numero, end_bairro, end_cidade, end_cep, end_tipo_residencia, end_observacao, is_deficiente, deficiencia, deficiencia_familia, has_convenio, observacao, is_aceite, indicacao, is_ativo, data_cadastro, data_atualizacao)
VALUES ( 'afe5b29e-35c8-40f6-b601-f8609c5fa086', 'Mariana', DATE('1995-07-25'), 28, '707070707', 'CASADO', 1, 'Ricardo resp', '11933333333', '44443333', 'ricardo_facebook', 'ricardo_instagram', 'ricardo@email.com', 'Enfermeira', 'Av das Águias', '456', 'Alphaville', 'Barueri', '06789012', 'APARTAMENTO', 'Próximo ao shopping', true, 'Nenhuma', 'Nenhuma', true, 'Observações importantes', true, 'Indicação do médico', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
