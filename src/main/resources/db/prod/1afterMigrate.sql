...
values (1,'a65bee75-2cb1-49d8-a31b-dfb6cbba39a3', 'Antonio',DATE('1974-01-01'), 49, '501818352', 'VIUVO', 7, 'Nineuda resp',
...
'Andreia irmã', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
false, 'n/a', 'n/a', true, 'observado', true,
'Net irmã', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
false, 'n/a', 'n/a', true, 'observado', true,
'Nireide esposa', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
false, 'n/a', 'n/a', true, 'observado', true,
'Batista marido', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
