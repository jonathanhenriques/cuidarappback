...
insert into tb_paciente (id,codigo, nome,  data_nasc, idade,  rg, estado_civil, has_filhos, nome_responsavel_paciente,
...
INTO
tb_paciente
(     id, codigo, nome, data_nasc, idade, rg, estado_civil, has_filhos, nome_responsavel_paciente, cont_celular, cont_telefone, cont_facebook, cont_instagram, cont_email, profissao, end_rua, end_numero, end_bairro, end_cidade, end_cep, end_tipo_residencia, end_observacao, is_deficiente, deficiencia, deficiencia_familia, is_has_convenio, observacao, is_aceite, indicacao, is_ativo, data_cadastro, data_atualizacao )
VALUES
