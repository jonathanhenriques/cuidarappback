...
insert into tb_paciente (codigo, nome,  data_nasc, idade,  rg, estado_civil, qtd_filhos, nome_responsavel_paciente,
...
is_deficiente,  deficiencia, deficiencia_familia, is_has_convenio, observacao, is_aceite,
indicacao, is_ativo, data_cadastro, data_atualizacao)
values ('a65bee75-2cb1-49d8-a31b-dfb6cbba39a3', 'Antonio','1974-04-15', 49, '501818352', 'VIUVO', 7, 'Nineuda resp',
...
insert into tb_paciente (id,codigo, nome,  data_nasc, idade,  rg, estado_civil, qtd_filhos, nome_responsavel_paciente,
cont_celular, cont_telefone, cont_facebook, cont_instagram, cont_email,
profissao, end_rua, end_numero, end_bairro,end_cidade, end_cep, end_tipo_residencia, end_observacao,
is_deficiente,  deficiencia, deficiencia_familia, is_has_convenio, observacao, is_aceite,
indicacao, is_ativo, data_cadastro, data_atualizacao)
...
-- ########################################################################################################################################################################################################################################################################
INSERT INTO tb_paciente ( codigo, nome, data_nasc, idade, rg, estado_civil, qtd_filhos, nome_responsavel_paciente, cont_celular, cont_telefone, cont_facebook, cont_instagram, cont_email, profissao, end_rua, end_numero, end_bairro, end_cidade, end_cep, end_tipo_residencia, end_observacao, is_deficiente, deficiencia, deficiencia_familia, is_has_convenio, observacao, is_aceite, indicacao, is_ativo, data_cadastro, data_atualizacao )
VALUES ( 'afe5b29e-35c8-40f6-b601-f8609c5fa023', 'Antonio', '1974-04-15', 49, '501818352', 'VIUVO', 7, 'Nineuda resp', '11940551452', '40551452', 'facebook.com', 'instagram.com', 'email@email.com', 'Professor', 'Rua das Árvores', '94', 'Bairro Lindo', 'São Bernardo', '09981011', 'OUTRO', 'do lado da granja', false, 'n/a', 'n/a', true, 'observado', true, 'Andreia irmã', true, CURRENT_DATE(), CURRENT_DATE() );

INSERT INTO tb_paciente (codigo,   nome,   data_nasc,   idade,   rg,   estado_civil,   qtd_filhos,   nome_responsavel_paciente,   cont_celular,   cont_telefone,   cont_facebook,   cont_instagram,   cont_email,   profissao,   end_rua,   end_numero,   end_bairro,   end_cidade,   end_cep,   end_tipo_residencia,   end_observacao,   is_deficiente,   deficiencia,   deficiencia_familia,   is_has_convenio,   observacao,   is_aceite,   indicacao,   is_ativo,   data_cadastro,   data_atualizacao )
VALUES ( 'b84fda4c-e3e8-4e34-92ab-f2ce8c72a15d',   'Maria',   '1990-10-20',   32,   '702345128',   'CASADO',   2,   'João responsável',   '11987654321',   '98765432',   'facebook_maria',   'instagram_maria',   'maria@email.com',   'Advogada',   'Avenida das Flores',   '123',   'Centro',   'São Paulo',   '01234567',   'CASA',   'Próximo à praça',   false,   'n/a',   'n/a',   true,   'Observações sobre Maria',   true,   'Amiga da família',   true,   CURRENT_DATE(),   CURRENT_DATE() );


INSERT INTO tb_paciente ( codigo,   nome,   data_nasc,   idade,   rg,   estado_civil,   qtd_filhos,   nome_responsavel_paciente,   cont_celular,   cont_telefone,   cont_facebook,   cont_instagram,   cont_email,   profissao,   end_rua,   end_numero,   end_bairro,   end_cidade,   end_cep,   end_tipo_residencia,   end_observacao,   is_deficiente,   deficiencia,   deficiencia_familia,   is_has_convenio,   observacao,   is_aceite,   indicacao,   is_ativo,   data_cadastro,   data_atualizacao )
VALUES ('c84c3a20-86f6-4a2d-9c95-ec3f7aaff4e1',   'João',   '1985-06-12',   38,   '801234567',   'SOLTEIRO',   0,   NULL,   '11999998888',   '99998888',   'facebook_joao',   'instagram_joao',   'joao@email.com',   'Engenheiro',   'Rua dos Carros',   '456',   'Bairro Novo',   'Porto Alegre',   '12345678',   'APARTAMENTO',   'Próximo à estação de metrô',   false,   'n/a',   'n/a',   false,   'Observações sobre João',   true,   NULL,   true,   CURRENT_DATE(),   CURRENT_DATE() );


INSERT INTO tb_paciente ( codigo,   nome,   data_nasc,   idade,   rg,   estado_civil,   qtd_filhos,   nome_responsavel_paciente,   cont_celular,   cont_telefone,   cont_facebook,   cont_instagram,   cont_email,   profissao,   end_rua,   end_numero,   end_bairro,   end_cidade,   end_cep,   end_tipo_residencia,   end_observacao,   is_deficiente,   deficiencia,   deficiencia_familia,   is_has_convenio,   observacao,   is_aceite,   indicacao,   is_ativo,   data_cadastro,   data_atualizacao )
VALUES ( 'f45303b7-efc5-4c77-a256-b8be956c3f10',   'Ana',   '1992-09-25',   31,   '904567123',   'CASADO',   1,   'Pedro responsável',   '11987655432',   '98765543',   'facebook_ana',   'instagram_ana',   'ana@email.com',   'Médica',   'Avenida das Palmeiras',   '789',   'Jardins',   'Rio de Janeiro',   '54321098',   'CASA',   'Próximo ao parque',   false,   'n/a',   'n/a',   true,   'Observações sobre Ana',   true,   'Indicação de um colega',   true,   CURRENT_DATE(),   CURRENT_DATE() );


INSERT INTO tb_paciente ( codigo,   nome,   data_nasc,   idade,   rg,   estado_civil,   qtd_filhos,   nome_responsavel_paciente,   cont_celular,   cont_telefone,   cont_facebook,   cont_instagram,   cont_email,   profissao,   end_rua,   end_numero,   end_bairro,   end_cidade,   end_cep,   end_tipo_residencia,   end_observacao,   is_deficiente,   deficiencia,   deficiencia_familia,   is_has_convenio,   observacao,   is_aceite,   indicacao,   is_ativo,   data_cadastro,   data_atualizacao )
VALUES ('b1f3a618-42a1-4c06-8c6c-df38739edfa3',   'Carlos',   '1988-03-08',   35,   '702345234',   'CASADO',   2,   'Julia responsável',   '11993456789',   '34567890',   'facebook_carlos',   'instagram_carlos',   'carlos@email.com',   'Engenheiro Civil',   'Rua dos Coqueiros',   '32',   'Centro',   'Curitiba',   '98765432',   'APARTAMENTO',   'Próximo ao shopping',   false,   'n/a',   'n/a',   true,   'Observações sobre Carlos',   true,   'Indicação de um amigo',   true,   CURRENT_DATE(),   CURRENT_DATE() );


INSERT INTO tb_paciente (codigo,   nome,   data_nasc,   idade,   rg,   estado_civil,   qtd_filhos,   nome_responsavel_paciente,   cont_celular,   cont_telefone,   cont_facebook,   cont_instagram,   cont_email,   profissao,   end_rua,   end_numero,   end_bairro,   end_cidade,   end_cep,   end_tipo_residencia,   end_observacao,   is_deficiente,   deficiencia,   deficiencia_familia,   is_has_convenio,   observacao,   is_aceite,   indicacao,   is_ativo,   data_cadastro,   data_atualizacao )
VALUES ( 'be19ed22-4b4a-478f-a28d-098d8ca91245',   'Laura',   '1995-11-02',   28,   '103254987',   'SOLTEIRO',   0,   NULL,   '11966665555',   '66665555',   'facebook_laura',   'instagram_laura',   'laura@email.com',   'Arquiteta',   'Rua das Montanhas',   '764',   'Alvorada',   'Porto Alegre',   '76543210',   'CASA',   'Próximo à praia',   false,   'n/a',   'n/a',   false,   'Observações sobre Laura',   true,   NULL,   true,   CURRENT_DATE(),   CURRENT_DATE() );
...
INSERT INTO tb_exame (id,data_exame, nome_exame, observacao, valor, atendente_id, local_id, is_ativo, medico_id, paciente_id)
...
INSERT INTO cuidarapp_schema.tb_exame (id,data_exame, nome_exame, observacao, valor, atendente_id, local_id, is_ativo, medico_id, paciente_id)
