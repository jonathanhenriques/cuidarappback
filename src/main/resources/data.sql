...
tb_paciente (paciente_id, rg, is_aceite, cont_celular, cont_facebook, cont_instagram, cont_email, cont_telefone, is_convenio,
 ...
 values (null, '501818352', true, '11983181377', 'facebook.com', 'instagram.com', 'email@email.com', '40028922', false,
     CURRENT_DATE(), '1997-05-05', '', '', false, 'Bairro Lindo', '09981011', 'Diadema', '189',
...
insert into tb_exame (id_exame, data_exame, local, medico, nome_exame, atendente, observacao, id_paciente, valor)
 values (null, CURRENT_DATE(), 'Diadema', 'Dr.Médico', 'Exame de Vista','SilvaAtendimentos', 'observações', 1, 50);

 insert into tb_exame (id_exame, data_exame, local, medico, nome_exame, atendente, observacao, id_paciente, valor)
  values (null, CURRENT_DATE(), 'Diadema', 'Dr.Médico', 'Exame de Vista 2','SilvaAtendimentos', 'observações', 1, 79);
  insert into tb_exame (id_exame, data_exame, local, medico, nome_exame, atendente, observacao, id_paciente, valor)

   values (null, CURRENT_DATE(), 'Diadema', 'Dr.Médico', 'Exame de Vista 3','SilvaAtendimentos', 'observações', 1, 33);

 insert into tb_exame (id_exame, data_exame, local, medico, nome_exame, atendente, observacao, id_paciente, valor)
  values (null, CURRENT_DATE(), 'Diadema', 'Veterinária', 'Castração','Andreia', 'observações', 2, 89);
...
insert into tb_exame (id_exame, data_exame, local, medico, nome_exame,atendente, observacao, id_paciente, valor)
 values (null, CURRENT_DATE(), 'Diadema', 'Dr.Saulo', 'Exame de Cabeã','Cida', 'observações', 3, 110);

insert into tb_exame (id_exame, data_exame, local, medico, nome_exame,atendente, observacao, id_paciente, valor)
 values (null, CURRENT_DATE(), 'Diadema', 'Dr.Dorivaldo', 'Exame do coração','Andreia', 'observações', 4, 210);

 insert into tb_exame (id_exame, data_exame, local, medico, nome_exame,atendente, observacao, id_paciente, valor)
  values (null, CURRENT_DATE(), 'Diadema', 'Dra.Ana', 'Exame do pulmão','Cida', 'observações', 5, 350);
